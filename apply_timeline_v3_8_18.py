...
BACKUP = Path("carousel_lib.py.before_timeline_v3_8_18")

NEW_FUNCTION = '''def draw_timeline(draw, entries, y0, line_x=None):
    """Timeline v3.8.18 with tighter fixed vertical distribution."""
    TIMELINE_DATE_SIZE = 48
    TIMELINE_BODY_SIZE = 42
    TIMELINE_BODY_LINE_ADVANCE = 50
    TIMELINE_MAX_W = 800
    TIMELINE_LINE_WIDTH = 5
    TIMELINE_NODE_RADIUS = 11
    TIMELINE_TOP_OFFSET = 62
    TIMELINE_MAX_SPAN = 430
...
def main() -> int:
    ...
    print("Timeline v3.8.18 applied successfully.")
