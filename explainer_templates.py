...
* body copy uses a stable 34px editorial size with 35px line advance
...
EXPLAINER_HEADLINE_INK_HEIGHT = {1: 164, 2: 128, 3: 108, 4: 96}
...
EXPLAINER_BODY_SIZE = 34
EXPLAINER_BODY_MIN_SIZE = 33
EXPLAINER_BODY_LINE_ADVANCE = 35
