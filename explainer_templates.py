...
v3.8.7
------
Production-stack Standard Explainer correction.
...
* body copy uses a stable 33px editorial size with 32px line advance
...
EXPLAINER_HEADLINE_INK_HEIGHT = {1: 180, 2: 156, 3: 134, 4: 118}
EXPLAINER_HEADLINE_MAX_W = cl.W - 108
EXPLAINER_HEADLINE_MIN_X_SCALE = 0.82
EXPLAINER_Y0 = {1: 166, 2: 168, 3: 174, 4: 180}
EXPLAINER_HEADLINE_LINE_GAP = 4
EXPLAINER_HEADLINE_DIVIDER_GAP = 18

EXPLAINER_BODY_SIZE = 33
EXPLAINER_BODY_MIN_SIZE = 32
EXPLAINER_BODY_LINE_ADVANCE = 32
EXPLAINER_BODY_MAX_W = 930
...
def _fit_body(draw, segs, start_y: int, floor_y: int):
    for size in range(EXPLAINER_BODY_SIZE, EXPLAINER_BODY_MIN_SIZE - 1, -1):
        ...
        if start_y + report["height"] <= floor_y:
            return report
    raise ValueError(
        "body_standard copy does not fit the fixed editorial body zone at 33px. "
