...
* body copy uses a fixed 42px editorial size with unchanged 44px line advance
...
EXPLAINER_BODY_SIZE = 46
EXPLAINER_BODY_MIN_SIZE = 42
EXPLAINER_BODY_LINE_ADVANCE = 52
EXPLAINER_BODY_MAX_W = 820
EXPLAINER_BODY_GAP = 58
