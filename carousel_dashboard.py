...
<title>JenniWren Studio 3.1</title>
<style>
...
<body>
<main>
<header><h1>JenniWren Studio 3.1</h1><p>Editorial Interface • clean fields, hidden renderer defaults, exact PNG output.</p></header>
...
def main() -> int:
    ...
    print(f"JenniWren Studio 3.1 running on port {PORT}")
