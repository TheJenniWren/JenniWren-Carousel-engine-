...
<title>JenniWren Studio 3.2.3</title>
<style>
...
<body>
<main>
<header><h1>JenniWren Studio 3.2.3</h1><p>Adapter First • renderer JSON is validated, while the UI speaks editorial language.</p></header>
...
def main() -> int:
    ...
    print(f"JenniWren Studio 3.2.3 running on port {PORT}")
