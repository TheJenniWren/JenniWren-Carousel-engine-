...
<title>JenniWren Studio v2.6</title>
<style>
...
<body>
<main>
<header><h1>JenniWren Studio v2.6</h1><p>Ten renderer-native templates with fields that change automatically.</p></header>
<section class="panel">
...
class StudioHandler(BaseHTTPRequestHandler):
    server_version = "JenniWrenStudio/2.6"
...
def main() -> int:
    ...
    print(f"JenniWren Studio v2.6 running on port {PORT}")
