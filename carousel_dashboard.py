...
<title>JenniWren Studio 3.3.3</title>
<style>
...
<body>
<main>
<header><h1>JenniWren Studio 3.3.3</h1><p>Renderer Execution • one answer: why no PNG was created.</p></header>
...
<section class="execution-answer" id="execution-answer">
  ...
  <div class="execution-title" id="execution-title">Renderer has not run yet.</div>
  <div class="execution-reason" id="execution-reason">Complete the required editorial fields to start a production render.</div>
...
def main() -> int:
    ...
    print(f"JenniWren Studio 3.3.3 running on port {PORT}")
