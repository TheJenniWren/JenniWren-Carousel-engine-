...
<title>JenniWren Studio v2.7.1</title>
<style>
...
<body>
<main>
<header><h1>JenniWren Studio v2.7.1</h1><p>Renderer-integrated templates driven by one schema registry.</p></header>
...
class StudioHandler(BaseHTTPRequestHandler):
    server_version = "JenniWrenStudio/2.7.1"
...
def main() -> int:
    ...
    print(f"JenniWren Studio v2.7.1 running on port {PORT}")
