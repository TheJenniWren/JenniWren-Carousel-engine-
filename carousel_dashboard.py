...
<title>JenniWren Studio 3.5</title>
<style>
...
<body>
<main>
<header><h1>JenniWren Studio 3.5</h1><p>Real Story Mode • the active editor slide renders through the production pipeline.</p></header>
...
<div class="first-cover-box real-story-box">
  <div>
    <strong>Real Story Preview</strong>
    <div class="first-cover-copy">Render the active slide exactly as it currently appears in the editor.</div>
  </div>
  <button type="button" id="render-current-slide">Render Current Slide</button>
</div>
<div class="actions">
...
<section class="execution-answer" id="execution-answer">
  ...
  <div class="execution-title" id="execution-title">Ready to render the active editor slide.</div>
  <div class="execution-reason" id="execution-reason">Complete the active slide, then tap Render Current Slide.</div>
...
async function refreshLivePreview(){
  ...
  try{
    ...
    renderExecutionAnswer({
      status:"waiting",
      title:"Rendering current editor slide",
      reason:"Studio is reading the visible fields, adapting the active slide, and running the production renderer.",
      next_action:"Wait for the renderer result."
    });
    setPreviewStatus("Reading editor, adapting, and rendering…","busy");
    ...
    setPreviewStatus(`✓ Real story preview • ${now}`,"good");
    updateThumbnailStrip();
...
document.getElementById("render-current-slide").addEventListener("click",refreshLivePreview);
...
def main() -> int:
    ...
    print(f"JenniWren Studio 3.5 running on port {PORT}")
