...
<title>JenniWren Studio v2.2</title>
<style>
...
class StudioHandler(BaseHTTPRequestHandler):
    server_version = "JenniWrenStudio/2.2"
...
def main() -> int:
    ...
    print(f"JenniWren Studio v2.2 running on port {PORT}")
