...
<title>JenniWren Studio 3.6</title>
<style>
...
<body>
<main>
<header><h1>JenniWren Studio 3.6</h1><p>Real Carousel Mode • the entire active story renders through one production pipeline.</p></header>
...
def main() -> int:
    ...
    print(f"JenniWren Studio 3.6 running on port {PORT}")
