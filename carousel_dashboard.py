...
<title>JenniWren Studio 3.7</title>
<style>
...
<body>
<main>
<header><h1>JenniWren Studio 3.7</h1><p>Template Engine • all ten production templates share one registry, editor, adapter, validator, and renderer.</p></header>
...
def main() -> int:
    ...
    print(f"JenniWren Studio 3.7 running on port {PORT}")
