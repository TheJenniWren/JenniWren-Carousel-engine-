...
def render_preview_payload(
    ...
    render_token = str(time.time_ns())
    return exit_code, log, output_slug, render_token, production_payload
...
<title>JenniWren Studio 3.3</title>
<style>
...
<body>
<main>
<header><h1>JenniWren Studio 3.3</h1><p>Production Preview • live preview and export use the same renderer.</p></header>
...
class StudioHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:
        ...
        if self.path == "/preview":
            ...
            try:
                exit_code, log, output_slug, render_token, production_payload = render_preview_payload(payload, slide_index)
...
def main() -> int:
    ...
    print(f"JenniWren Studio 3.3 running on port {PORT}")
