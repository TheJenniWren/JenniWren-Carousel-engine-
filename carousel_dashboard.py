...
<title>JenniWren Studio 3.2</title>
<style>
...
<body>
<main>
<header><h1>JenniWren Studio 3.2</h1><p>Renderer Integration • every preview is a production-rendered PNG.</p></header>
...
def main() -> int:
    ...
    print(f"JenniWren Studio 3.2 running on port {PORT}")
