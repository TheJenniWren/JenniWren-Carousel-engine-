...
<title>JenniWren Studio v2.7</title>
<style>
...
const SCHEMA_REGISTRY=__SCHEMA_REGISTRY__;
const schemas=Object.fromEntries(
  Object.entries(SCHEMA_REGISTRY).map(([template,schema])=>[
    template,
...
function addSlide(data={}){
  ...
  article.querySelector("[data-template]").value=normalized.template;
...
class StudioHandler(BaseHTTPRequestHandler):
    server_version = "JenniWrenStudio/2.7"
...
def main() -> int:
    ...
    print(f"JenniWren Studio v2.7 running on port {PORT}")
